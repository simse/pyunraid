...
class Container(Model):
    ...
    :ivar port_mappings: Array of port mappings (e.g. [['5050', '5000'],
    ['80', '81']])
    :ivar path_mappings: Array of path mappings (e.g. [['/chronos',
    '/mnt/user/appdata/chronos']])
    ...
    def remove(self, remove_image=False):
        ...
        :param remove_image: Whether to also remove Docker image or leave it
         orphaned.
        """
        if remove_image:
    ...
    # TODO: Read logs from /plugins/dynamix.docker.manager/include/Events.php
